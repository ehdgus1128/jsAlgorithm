 ...
 */
const solution4_1 = (len:number, arr:number[]):number => {
 ...
 * 상품가격은 짝수로만 입력
 */
const solution4_4 = (n: number, arr: number[][]) => {
    let answer = 0;
 ...
 */
const solution4_5 = (k : number, arr : number[]) => {
    let answer = -1;
    ...
    */
    ...
    let a = Array.from(tmp).sort((a : number, b : number) => b - a);
    answer = a[k - 1];
